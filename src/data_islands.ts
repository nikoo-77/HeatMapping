...
export const PHILIPPINE_REGIONS: PhilippineRegion[] = [
  ...
  { code: 'VI',    name: 'Western Visayas',           islandGroup: 'Visayas', color: 'blue',   bounds: [9.8, 121.5, 11.8, 123.2] },
  { code: 'VII',   name: 'Central Visayas',           islandGroup: 'Visayas', color: 'indigo', bounds: [9.2, 123.2, 11.5, 124.5] },
